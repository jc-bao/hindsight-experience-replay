...
class VecEnv(ABC):
    ...
    def env_method(self, method_name, *method_config, indices=None, **method_kwargs):
        ...
        :param method_config: (tuple) Any positional arguments to provide in the call
    ...
    def render(self, mode: str, *config, **kwargs):
        """
        ...
        """
        try:
            imgs = self.get_images(*config, **kwargs)
...
class VecEnvWrapper(VecEnv):
    ...
    def render(self, *config, **kwargs):
        return self.venv.render(*config, **kwargs)
    ...
    def env_method(self, method_name, *method_config, indices=None, **method_kwargs):
        return self.venv.env_method(method_name, *method_config, indices=indices, **method_kwargs)
